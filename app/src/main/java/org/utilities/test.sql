...
-- * Generation date: Thu Jul 11 15:49:41 2024 
-- * LUN file: C:\Users\Oradzie\Code\DBMS-project\schemaER.lun 
-- * Schema: SCHEMA/1 
-- ********************************************* 
...
create table Dipendente (
     ...
     Magazziniere char(20),
     Amministratore char(20),
...
create table PromozioneCategoria (
     ...
     NomeProdotto char(30) not null,
     constraint ID_PromozioneCategoria_ID primary key (IDPromozione));
...
alter table Dipendente add constraint EXTONE_Dipendente
     check((Amministratore is not null and Magazziniere is null)
           or (Amministratore is null and Magazziniere is not null)); 
...
alter table Persona add constraint LSTONE_Persona
     check(Dipendente is not null or UtenteOnline is not null); 
...
alter table PromozioneCategoria add constraint FKOffertaCategoria_FK
...
create unique index ID_PromozioneCategoria_IND
     on PromozioneCategoria (IDPromozione);

create index FKOffertaCategoria_IND
     on PromozioneCategoria (NomeProdotto);
